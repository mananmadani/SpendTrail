...
function backupData() {
  ...
  const backup = { ...data, backupDate: new Date().toISOString(), version:'4.0.1', profileName: profile?.name||'Personal' };
...
function encryptedBackup() {
  ...
  const data = getData(), profile = getActiveProfile();
  const backup = { ...data, backupDate:new Date().toISOString(), version:'4.0.1', encrypted:true, profileName:profile?.name||'Personal' };
  ...
  const content = `
    <div style="line-height:1.7;color:#424242;">
      ...
      <div style="text-align:center;padding-top:8px;padding-bottom:4px;">
        <p style="font-size:12px;color:#BDBDBD;margin:0;">Last Updated: March 2026 &nbsp;|&nbsp; Version 4.0.1</p>
      </div>
