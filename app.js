...
// Function to set today's date - NUCLEAR VERSION
function setTodayDate() {
    ...
    if (incomeDate) {
        incomeDate.removeAttribute('value');
        incomeDate.value = '';
        setTimeout(() => {
    ...
    if (expenseDate) {
        expenseDate.removeAttribute('value');
        expenseDate.value = '';
        setTimeout(() => {
...
function initialize() {
    ...
    // Set date after a small delay to ensure DOM is ready
