...
function sortTransactions(transactions) {
  return transactions.sort((a, b) => {
    ...
    // If dates are same, sort by timestamp (most recent first)
...
function cancelEdit() {
  // When canceling edit, go back to the previous view instead of just closing
...
function showAnalytics(days = 30, type = 'expense') {
  ...
  // Calculate category totals based on type
...
function showPrivacy() {
  const content = `
    <div style="line-height:1.7;color:#424242;">
      ...
      <p style="margin-top:24px;font-size:13px;color:#757575;text-align:center;">Last Updated: December 2025 | Version 3.6</p>
    </div>
  `;
